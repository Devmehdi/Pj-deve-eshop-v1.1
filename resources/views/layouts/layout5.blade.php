				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<a href="#" class="single-icon"><i class="ti-bag"></i> <span class="total-count">{{$counts}}</span></a>
								<!-- Shopping Item -->
									...
									<ul class="shopping-list">
										@foreach ($panels as $panel)
											<li>
												...
												<a class="cart-img" href="#"><img src="{{asset('storage/'.$panel->imageproduct)}}" alt="#"></a>
												<h4><a href="#"></a></h4>
												<p class="quantity">1x - <span class="amount">{{$panel->price}}</span></p>
											</li>
										@endforeach
										...
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="#">Blog<i class="ti-angle-down"></i></a>
														<ul class="dropdown">
															<li><a href="{{url('blog')}}">Blog Single Sidebar</a></li>
														</ul>
													</li>
												</ul>
										</div>
